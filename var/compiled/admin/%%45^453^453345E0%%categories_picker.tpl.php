...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'pickers/categories_picker.tpl', 3, false),array('modifier', 'is_array', 'pickers/categories_picker.tpl', 15, false),array('modifier', 'explode', 'pickers/categories_picker.tpl', 16, false),array('modifier', 'implode', 'pickers/categories_picker.tpl', 32, false),array('modifier', 'fn_check_view_permissions', 'pickers/categories_picker.tpl', 85, false),array('modifier', 'escape', 'pickers/categories_picker.tpl', 111, false),array('function', 'math', 'pickers/categories_picker.tpl', 4, false),array('function', 'script', 'pickers/categories_picker.tpl', 9, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('position_short','name','no_items','add_categories','remove_this_item','remove_this_item','choose','choose','choose','choose','add_categories_and_close','add_categories','remove_this_item','remove_this_item','add_categories','close','close'));
?>

<?php $this->assign('data_id', smarty_modifier_default(@$__tpl_vars['data_id'], 'categories_list'), false); ?>
...
<?php if ($__tpl_vars['item_ids'] && $__tpl_vars['multiple'] && ! is_array($__tpl_vars['item_ids'])): ?>
	<?php $this->assign('item_ids', explode(",", $__tpl_vars['item_ids']), false); ?>
<?php endif; ?>

<?php if (! $__tpl_vars['extra_var'] && $__tpl_vars['view_mode'] != 'button'): ?>
...
"<?php if (! $__tpl_vars['item_ids']): ?> class="hidden"<?php endif; ?>>
	<?php else: ?>
		<div id="<?php echo $__tpl_vars['data_id']; ?>
" class="<?php if ($__tpl_vars['multiple'] && ! $__tpl_vars['item_ids']): ?>hidden<?php elseif (! $__tpl_vars['multiple']): ?>cm-display-radio float-left<?php endif; ?>">
	<?php endif; ?>
		<input id="<?php if ($__tpl_vars['input_id']): ?><?php echo $__tpl_vars['input_id']; ?>
<?php else: ?>c<?php echo $__tpl_vars['data_id']; ?>
_ids<?php endif; ?>" type="hidden" class="cm-picker-value" name="<?php echo $__tpl_vars['input_name']; ?>
" value="<?php if (is_array($__tpl_vars['item_ids'])): ?><?php echo implode(",", $__tpl_vars['item_ids']); ?>
<?php else: ?><?php echo $__tpl_vars['item_ids']; ?>
<?php endif; ?>" <?php echo $__tpl_vars['extra']; ?>
 />
		<?php if ($__tpl_vars['multiple']): ?>
			<?php $_smarty_tpl_vars = $__tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "pickers/js_category.tpl", 'smarty_include_vars' => array('category_id' => ($__tpl_vars['ldelim'])."category_id".($__tpl_vars['rdelim']),'holder' => $__tpl_vars['data_id'],'input_name' => $__tpl_vars['input_name'],'clone' => true,'hide_link' => $__tpl_vars['hide_link'],'hide_delete_button' => $__tpl_vars['hide_delete_button'],'position_field' => $__tpl_vars['positions'],'position' => '0')));
...
if ($this->_foreach['items']['total'] > 0):
    foreach ($_from_2649667615 as $__tpl_vars['c_id']):
        $this->_foreach['items']['iteration']++;
?>
			<?php $_smarty_tpl_vars = $__tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "pickers/js_category.tpl", 'smarty_include_vars' => array('category_id' => $__tpl_vars['c_id'],'holder' => $__tpl_vars['data_id'],'input_name' => $__tpl_vars['input_name'],'hide_link' => $__tpl_vars['hide_link'],'hide_delete_button' => $__tpl_vars['hide_delete_button'],'first_item' => ($this->_foreach['items']['iteration'] <= 1),'position_field' => $__tpl_vars['positions'],'position' => $this->_foreach['items']['iteration']+$__tpl_vars['start_pos'])));
$__tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		<?php endforeach; else: ?>
			<?php if (! $__tpl_vars['multiple']): ?>
				<?php $_smarty_tpl_vars = $__tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "pickers/js_category.tpl", 'smarty_include_vars' => array('category_id' => "",'holder' => $__tpl_vars['data_id'],'input_name' => $__tpl_vars['input_name'],'hide_link' => $__tpl_vars['hide_link'],'hide_delete_button' => $__tpl_vars['hide_delete_button'])));
$__tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
			<?php endif; ?>
...
_no_item"<?php if ($__tpl_vars['item_ids']): ?> class="hidden"<?php endif; ?>>
		<tr class="no-items">
			<td colspan="<?php if ($__tpl_vars['positions']): ?>3<?php else: ?>2<?php endif; ?>"><p><?php echo smarty_modifier_default(@$__tpl_vars['no_item_text'], fn_get_lang_var('no_items', $this->getLanguage())); ?>
</p></td>
		</tr>
		</tbody>
	</table>
...
<?php if ($__tpl_vars['view_mode'] != 'list'): ?>
	...
	<?php if (! $__tpl_vars['no_container']): ?><div class="<?php if (! $__tpl_vars['multiple']): ?>choose-icon<?php else: ?>buttons-container<?php endif; ?>"><?php endif; ?>
		<?php if ($__tpl_vars['multiple']): ?>
...
/icons/icon_choose_object.gif" width="19" height="18" border="0" class="hand" id="opener_picker_<?php echo $__tpl_vars['data_id']; ?>
" onclick="jQuery.show_picker('picker_<?php echo $__tpl_vars['data_id']; ?>
...
?dispatch=categories.picker<?php if (! $__tpl_vars['multiple']): ?>&amp;display=radio<?php endif; ?><?php if ($__tpl_vars['extra_var']): ?>&amp;extra=<?php echo smarty_modifier_escape($__tpl_vars['extra_var'], 'url'); ?>
<?php endif; ?><?php if ($__tpl_vars['default_name']): ?>&amp;root=<?php echo $__tpl_vars['default_name']; ?>
<?php endif; ?><?php if ($__tpl_vars['checkbox_name']): ?>&amp;checkbox_name=<?php echo $__tpl_vars['checkbox_name']; ?>
<?php endif; ?><?php if ($__tpl_vars['except_id']): ?>&amp;except_id=<?php echo $__tpl_vars['except_id']; ?>
		...
		<div class="buttons-container">
			...
			<?php else: ?>
				<?php if (! $__tpl_vars['extra_var']): ?>
					...
					<?php ob_start(); ?>
						<?php $__parent_tpl_vars = $__tpl_vars;$__tpl_vars = array_merge($__tpl_vars, array('but_type' => 'button', 'but_onclick' => "jQuery.submit_picker('#iframe_".($__tpl_vars['data_id'])."', '#add_item')", 'but_text' => fn_get_lang_var('add_categories', $this->getLanguage()), )); ?>
