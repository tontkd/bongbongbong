...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'buttons/create_cancel.tpl', 1, false),array('modifier', 'fn_check_view_permissions', 'buttons/create_cancel.tpl', 29, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('create','remove_this_item','remove_this_item','or','cancel','cancel'));
?>
<?php  ob_start();  ?>
<?php $__parent_tpl_vars = $__tpl_vars;$__tpl_vars = array_merge($__tpl_vars, array('but_text' => smarty_modifier_default(@$__tpl_vars['but_text'], fn_get_lang_var('create', $this->getLanguage())), 'but_onclick' => $__tpl_vars['but_onclick'], 'but_role' => 'button_main', 'but_name' => $__tpl_vars['but_name'], 'but_meta' => $__tpl_vars['but_meta'], )); ?>
...
<?php if ($__tpl_vars['extra']): ?>
	<?php echo $__tpl_vars['extra']; ?>

<?php endif; ?>

<?php if ($__tpl_vars['cancel_action'] || $__tpl_vars['breadcrumbs']): ?>&nbsp;<?php echo fn_get_lang_var('or', $this->getLanguage()); ?>
&nbsp;&nbsp;<?php endif; ?>

<?php if ($__tpl_vars['cancel_action'] == 'close'): ?>
	<a class="cm-popup-switch cm-cancel tool-link"><?php echo fn_get_lang_var('cancel', $this->getLanguage()); ?>
</a>
<?php elseif ($__tpl_vars['breadcrumbs']): ?>
	<?php $_from_1561183700 = & $__tpl_vars['breadcrumbs']; if (!is_array($_from_1561183700) && !is_object($_from_1561183700)) { settype($_from_1561183700, 'array'); }$this->_foreach['fe_b'] = array('total' => count($_from_1561183700), 'iteration' => 0);
...
?>
	...
	<a href="<?php echo $__tpl_vars['b']['link']; ?>
