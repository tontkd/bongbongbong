...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'buttons/save_cancel.tpl', 1, false),array('modifier', 'fn_check_view_permissions', 'buttons/save_cancel.tpl', 29, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('save','remove_this_item','remove_this_item','or','cancel','cancel'));
?>
<?php  ob_start();  ?>
<?php $__parent_tpl_vars = $__tpl_vars;$__tpl_vars = array_merge($__tpl_vars, array('but_text' => smarty_modifier_default(@$__tpl_vars['but_text'], fn_get_lang_var('save', $this->getLanguage())), 'but_onclick' => $__tpl_vars['but_onclick'], 'but_role' => 'button_main', 'but_name' => $__tpl_vars['but_name'], 'but_meta' => $__tpl_vars['but_meta'], )); ?>
