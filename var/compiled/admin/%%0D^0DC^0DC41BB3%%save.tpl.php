<?php /* Smarty version 2.6.18, created on 2011-12-01 22:08:21
         compiled from buttons/save.tpl */ 
 $__tpl_vars = & $this->_tpl_vars;
 ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_check_view_permissions', 'buttons/save.tpl', 29, false),array('modifier', 'default', 'buttons/save.tpl', 32, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('save','remove_this_item','remove_this_item'));
?>
<?php  ob_start();  ?>
<?php $__parent_tpl_vars = $__tpl_vars;$__tpl_vars = array_merge($__tpl_vars, array('but_text' => fn_get_lang_var('save', $this->getLanguage()), 'but_onclick' => $__tpl_vars['but_onclick'], 'but_href' => $__tpl_vars['but_href'], 'but_role' => $__tpl_vars['but_role'], )); ?>
