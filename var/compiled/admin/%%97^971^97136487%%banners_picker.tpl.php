<?php /* Smarty version 2.6.18, created on 2011-12-01 22:07:29
         compiled from addons/banners/pickers/banners_picker.tpl */ 
 $__tpl_vars = & $this->_tpl_vars;
 ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'addons/banners/pickers/banners_picker.tpl', 3, false),array('function', 'script', 'addons/banners/pickers/banners_picker.tpl', 7, false),array('modifier', 'default', 'addons/banners/pickers/banners_picker.tpl', 5, false),array('modifier', 'implode', 'addons/banners/pickers/banners_picker.tpl', 11, false),array('modifier', 'fn_get_banner_name', 'addons/banners/pickers/banners_picker.tpl', 26, false),array('modifier', 'fn_check_view_permissions', 'addons/banners/pickers/banners_picker.tpl', 89, false),array('modifier', 'escape', 'addons/banners/pickers/banners_picker.tpl', 111, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('position_short','name','no_items','add','remove_this_item','remove_this_item','add_banners_and_close','add_banners','add_banners','add_banners','close','close'));
?>
...
<?php if ($__tpl_vars['view_mode'] != 'button'): ?>
	<?php if (! $__tpl_vars['positions']): ?>
	<input id="b<?php echo $__tpl_vars['data_id']; ?>
...
"<?php if (! $__tpl_vars['item_ids']): ?> class="hidden"<?php endif; ?>>
	<?php $__parent_tpl_vars = $__tpl_vars;$__tpl_vars = array_merge($__tpl_vars, array('banner_id' => ($__tpl_vars['ldelim'])."banner_id".($__tpl_vars['rdelim']), 'holder' => $__tpl_vars['data_id'], 'input_name' => $__tpl_vars['input_name'], 'clone' => true, 'hide_link' => $__tpl_vars['hide_link'], 'hide_delete_button' => $__tpl_vars['hide_delete_button'], 'position_field' => $__tpl_vars['positions'], 'position' => '0', )); ?>

<?php if ($__tpl_vars['banner_id'] == '0'): ?>
	<?php $this->assign('banner', $__tpl_vars['default_name'], false); ?>
<?php else: ?>
	<?php $this->assign('banner', smarty_modifier_default(fn_get_banner_name($__tpl_vars['banner_id']), ($__tpl_vars['ldelim'])."banner".($__tpl_vars['rdelim'])), false); ?>
<?php endif; ?>

<tr <?php if (! $__tpl_vars['clone']): ?>id="b_<?php echo $__tpl_vars['banner_id']; ?>
...
?dispatch=banners.update&amp;banner_id=<?php echo $__tpl_vars['banner_id']; ?>
"><?php echo $__tpl_vars['banner']; ?>
</a></td>
	<td><?php if (! $__tpl_vars['hide_delete_button'] && ! $__tpl_vars['view_only']): ?><a onclick="jQuery.delete_js_item('<?php echo $__tpl_vars['holder']; ?>
', '<?php echo $__tpl_vars['banner_id']; ?>
', 'b'); return false;"><img width="12" height="18" border="0" class="hand valign" alt="" src="<?php echo $__tpl_vars['images_dir']; ?>
/icons/icon_delete.gif"/></a><?php else: ?>&nbsp;<?php endif; ?></td>
</tr><?php if (isset($__parent_tpl_vars)) { $__tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?>
...
if ($this->_foreach['items']['total'] > 0):
    foreach ($_from_2649667615 as $__tpl_vars['p_id']):
        $this->_foreach['items']['iteration']++;
?>
		<?php $__parent_tpl_vars = $__tpl_vars;$__tpl_vars = array_merge($__tpl_vars, array('banner_id' => $__tpl_vars['p_id'], 'holder' => $__tpl_vars['data_id'], 'input_name' => $__tpl_vars['input_name'], 'hide_link' => $__tpl_vars['hide_link'], 'hide_delete_button' => $__tpl_vars['hide_delete_button'], 'first_item' => ($this->_foreach['items']['iteration'] <= 1), 'position_field' => $__tpl_vars['positions'], 'position' => $this->_foreach['items']['iteration'], )); ?>
...
<?php if ($__tpl_vars['view_mode'] != 'list'): ?>
	...
	<?php if (! $__tpl_vars['no_container']): ?><div class="buttons-container"><?php endif; ?>
		<?php $__parent_tpl_vars = $__tpl_vars;$__tpl_vars = array_merge($__tpl_vars, array('but_id' => "opener_picker_".($__tpl_vars['data_id']), 'but_text' => fn_get_lang_var('add', $this->getLanguage()), 'but_onclick' => "jQuery.show_picker('picker_".($__tpl_vars['data_id'])."', this.id);", 'but_role' => 'add', 'but_meta' => "text-button", )); ?>
...
?dispatch=banners.picker<?php if ($__tpl_vars['extra_var']): ?>&amp;extra=<?php echo smarty_modifier_escape($__tpl_vars['extra_var'], 'url'); ?>
...
"></div>
		<div class="buttons-container">
			<?php if (! $__tpl_vars['extra_var']): ?>
				...
				<?php ob_start(); ?>
					<?php $_smarty_tpl_vars = $__tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "buttons/save_cancel.tpl", 'smarty_include_vars' => array('but_type' => 'button','but_onclick' => "jQuery.submit_picker('#iframe_".($__tpl_vars['data_id'])."', '#add_item')",'but_text' => fn_get_lang_var('add_banners', $this->getLanguage()),'breadcrumbs' => "")));
...
unset($_smarty_tpl_vars);
 ?>
	...
	<?php $__parent_tpl_vars = $__tpl_vars;$__tpl_vars = array_merge($__tpl_vars, array('picker_content' => $this->_smarty_vars['capture']['picker_content'], 'data_id' => $__tpl_vars['data_id'], 'but_text' => fn_get_lang_var('add_banners', $this->getLanguage()), )); ?>
