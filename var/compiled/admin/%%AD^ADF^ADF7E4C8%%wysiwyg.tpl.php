...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'lower', 'common_templates/wysiwyg.tpl', 7, false),array('modifier', 'fn_check_view_permissions', 'common_templates/wysiwyg.tpl', 48, false),array('modifier', 'default', 'common_templates/wysiwyg.tpl', 51, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('edit_in_visual_editor','remove_this_item','remove_this_item','view_source','remove_this_item','remove_this_item'));
?>
<?php  ob_start();  ?>
...
node.src = '<?php echo $__tpl_vars['config']['current_path']; ?>
...
<p>
<?php $__parent_tpl_vars = $__tpl_vars;$__tpl_vars = array_merge($__tpl_vars, array('but_text' => fn_get_lang_var('edit_in_visual_editor', $this->getLanguage()), 'but_onclick' => "jQuery.openEditor(this.id.str_replace('on_b', ''));", 'but_role' => 'simple', 'but_meta' => "text-button cm-combination", 'but_id' => "on_b".($__tpl_vars['id']), )); ?>
...
<?php $__parent_tpl_vars = $__tpl_vars;$__tpl_vars = array_merge($__tpl_vars, array('but_text' => fn_get_lang_var('view_source', $this->getLanguage()), 'but_onclick' => "jQuery.openEditor(this.id.str_replace('off_b', ''));", 'but_role' => 'simple', 'but_meta' => "text-button cm-combination hidden", 'but_id' => "off_b".($__tpl_vars['id']), )); ?>
