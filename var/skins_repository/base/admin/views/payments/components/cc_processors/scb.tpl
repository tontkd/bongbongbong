{* $Id: scb.tpl 6560 2008-12-15 11:41:36Z zeke $ *}

{assign var="return_url" value="`$config.http_location`/`$config.customer_index`?dispatch=payment_notification.result&payment=scb"}
<p>{$lang.text_scb_notice|replace:"[return_url]":$return_url}</p>
<hr />
