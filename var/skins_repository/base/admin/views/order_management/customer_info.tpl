{* $Id: customer_info.tpl 7760 2009-07-29 11:53:02Z zeke $ *}
...
{if $customer_auth.user_id && $settings.General.user_multiple_profiles == "Y"} {* Select user profile *}
	<div class="form-field">
		...
		<select name="profile_id" id="profile_id" onchange="jQuery.redirect('{$index_script}?dispatch=order_management.customer_info&profile_id='+this.value);" class="select-expanded">
...
{include file="views/profiles/components/profile_fields.tpl" user_data=$cart.user_data section="S" title=$lang.shipping_address body_id="sa" shipping_flag=$profile_fields.B|@sizeof|default:false ship_to_another=$cart.ship_to_another}
...
<div class="buttons-container buttons-bg center">
	<div class="float-left">
		{include file="buttons/save.tpl" but_name="dispatch[order_management.customer_info]" but_role="button_main"}
	</div>
