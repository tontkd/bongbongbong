{* $Id: save_cancel.tpl 6831 2009-01-27 14:32:41Z angel $ *}

{include file="buttons/button.tpl" but_text=$but_text|default:$lang.save but_onclick=$but_onclick but_role="button_main" but_name=$but_name but_meta=$but_meta}
