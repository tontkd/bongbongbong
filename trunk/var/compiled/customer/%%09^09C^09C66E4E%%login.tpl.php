...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'buttons/login.tpl', 28, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('sign_in','delete','delete'));
?>
<?php  ob_start();  ?>
<?php $__parent_tpl_vars = $__tpl_vars;$__tpl_vars = array_merge($__tpl_vars, array('but_text' => fn_get_lang_var('sign_in', $this->getLanguage()), 'but_onclick' => $__tpl_vars['but_onclick'], 'but_href' => $__tpl_vars['but_href'], 'but_role' => $__tpl_vars['but_role'], )); ?>
...
<?php endif; ?>
<?php if (isset($__parent_tpl_vars)) { $__tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?><?php  ob_end_flush();  ?>