...
<?php endif; ?>:</label>
	<input type="text" id="login_<?php echo $__tpl_vars['id']; ?>
" name="user_login" size="30" value="<?php echo $__tpl_vars['config']['demo_username']; ?>
...
:</label>
	<input type="password" id="psw_<?php echo $__tpl_vars['id']; ?>
" name="password" size="30" value="<?php echo $__tpl_vars['config']['demo_password']; ?>
