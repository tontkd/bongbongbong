<?php /* Smarty version 2.6.18, created on 2011-11-30 23:26:54
         compiled from views/products/components/products.tpl */ 
 $__tpl_vars = & $this->_tpl_vars;
 ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'script', 'views/products/components/products.tpl', 5, false),array('function', 'math', 'views/products/components/products.tpl', 82, false),array('modifier', 'default', 'views/products/components/products.tpl', 10, false),array('modifier', 'fn_query_remove', 'views/products/components/products.tpl', 28, false),array('modifier', 'escape', 'views/products/components/products.tpl', 28, false),array('modifier', 'trim', 'views/products/components/products.tpl', 65, false),array('modifier', 'fn_generate_thumbnail', 'views/products/components/products.tpl', 89, false),array('modifier', 'unescape', 'views/products/components/products.tpl', 132, false),array('modifier', 'strip_tags', 'views/products/components/products.tpl', 141, false),array('modifier', 'truncate', 'views/products/components/products.tpl', 141, false),array('modifier', 'strlen', 'views/products/components/products.tpl', 141, false),array('block', 'hook', 'views/products/components/products.tpl', 65, false),)), $this); ?>
<?php
