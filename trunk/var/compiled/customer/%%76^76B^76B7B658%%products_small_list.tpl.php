<?php /* Smarty version 2.6.18, created on 2011-11-30 23:27:16
         compiled from views/products/components/products_small_list.tpl */ 
 $__tpl_vars = & $this->_tpl_vars;
 ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'views/products/components/products_small_list.tpl', 17, false),array('modifier', 'fn_query_remove', 'views/products/components/products_small_list.tpl', 35, false),array('modifier', 'escape', 'views/products/components/products_small_list.tpl', 35, false),array('modifier', 'sizeof', 'views/products/components/products_small_list.tpl', 69, false),array('modifier', 'trim', 'views/products/components/products_small_list.tpl', 88, false),array('modifier', 'fn_generate_thumbnail', 'views/products/components/products_small_list.tpl', 113, false),array('modifier', 'unescape', 'views/products/components/products_small_list.tpl', 154, false),array('modifier', 'strip_tags', 'views/products/components/products_small_list.tpl', 154, false),array('modifier', 'truncate', 'views/products/components/products_small_list.tpl', 154, false),array('function', 'script', 'views/products/components/products_small_list.tpl', 20, false),array('function', 'split', 'views/products/components/products_small_list.tpl', 72, false),array('function', 'math', 'views/products/components/products_small_list.tpl', 76, false),array('block', 'hook', 'views/products/components/products_small_list.tpl', 88, false),)), $this); ?>
<?php
...
<?php if ($__tpl_vars['show_price_values'] && $__tpl_vars['settings']['General']['allow_anonymous_shopping'] == 'P' && ! $__tpl_vars['auth']['user_id']): ?>
<?php $this->assign('show_price_values', '0', false); ?>
<?php else: ?>
<?php $this->assign('show_price_values', '1', false); ?>
<?php endif; ?>
...
<?php $this->assign('img_width', '2', false); ?>
<?php $this->assign('space_width', '2', false); ?>
<?php echo smarty_function_math(array('equation' => "(100 + space_width) / x - space_width - img_width",'x' => smarty_modifier_default(@$__tpl_vars['columns'], '2'),'assign' => 'cell_width','space_width' => $__tpl_vars['space_width'],'img_width' => $__tpl_vars['img_width']), $this);?>

<?php echo smarty_function_math(array('equation' => "cell_width + img_width",'cell_width' => $__tpl_vars['cell_width'],'img_width' => $__tpl_vars['img_width'],'assign' => '2_cell_width'), $this);?>
...
<?php $_from_1052663597 = & $__tpl_vars['splitted_products']; if (!is_array($_from_1052663597) && !is_object($_from_1052663597)) { settype($_from_1052663597, 'array'); }$this->_foreach['splitted_products'] = array('total' => count($_from_1052663597), 'iteration' => 0);
if ($this->_foreach['splitted_products']['total'] > 0):
    foreach ($_from_1052663597 as $__tpl_vars['sproducts']):
        $this->_foreach['splitted_products']['iteration']++;
?>
<tr>
...
?>
	<td valign="top" <?php if (! ($this->_foreach['splitted_products']['iteration'] == $this->_foreach['splitted_products']['total'])): ?>class="border-bottom"<?php endif; ?> style="width: <?php echo $__tpl_vars['cell_width']; ?>
%;">
		<?php if ($__tpl_vars['product']): ?>
		<?php if ($__tpl_vars['addons']['age_verification']['status'] == 'A'): ?><?php ob_start();
$_smarty_tpl_vars = $__tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "addons/age_verification/hooks/products/product_small_list.override.tpl", 'smarty_include_vars' => array()));
$__tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
...
<?php else: ?><?php $this->_tag_stack[] = array('hook', array('name' => "products:product_small_list")); $_block_repeat=true;smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<?php $this->assign('obj_id', ($__tpl_vars['obj_prefix']).($__tpl_vars['product']['product_id']), false); ?>
		<table border="0" cellpadding="3" cellspacing="3" width="100%">
		<tr>
			<td class="center" valign="top" width="<?php echo $__tpl_vars['img_width']; ?>
%">
			<a href="<?php echo $__tpl_vars['index_script']; ?>
?dispatch=products.view&amp;product_id=<?php echo $__tpl_vars['product']['product_id']; ?>
"><?php $__parent_tpl_vars = $__tpl_vars;$__tpl_vars = array_merge($__tpl_vars, array('image_width' => '40', 'obj_id' => $__tpl_vars['obj_id'], 'images' => $__tpl_vars['product']['main_pair'], 'object_type' => 'product', )); ?>
...
?dispatch=products.view&amp;product_id=<?php echo $__tpl_vars['product']['product_id']; ?>
"<?php if ($__tpl_vars['columns'] > 1): ?> title="<?php echo smarty_modifier_unescape($__tpl_vars['product']['product']); ?>
"><?php echo smarty_modifier_truncate(smarty_modifier_strip_tags(smarty_modifier_unescape($__tpl_vars['product']['product'])), 30, "...", true); ?>
<?php else: ?>><?php echo smarty_modifier_unescape($__tpl_vars['product']['product']); ?>
<?php endif; ?></a>
			<?php $_smarty_tpl_vars = $__tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "views/products/components/buy_now.tpl", 'smarty_include_vars' => array('but_role' => 'text','but_meta' => "cm-tools-list",'but_rev' => "product_form_".($__tpl_vars['obj_id']),'simple' => true,'obj_id' => $__tpl_vars['obj_id'],'hide_wishlist_button' => true,'hide_compare_list_button' => true,'hide_add_to_cart_button' => $__tpl_vars['hide_add_to_cart_button'])));
$__tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		</td>
	...
	<?php if (! ($this->_foreach['sproducts']['iteration'] == $this->_foreach['sproducts']['total'])): ?>
	<td width="<?php echo $__tpl_vars['space_width']; ?>
%">&nbsp;</td>
	<?php endif; ?>
<?php endforeach; endif; unset($_from); ?>
</tr>
