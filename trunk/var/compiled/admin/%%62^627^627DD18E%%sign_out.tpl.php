...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_check_view_permissions', 'buttons/sign_out.tpl', 29, false),array('modifier', 'default', 'buttons/sign_out.tpl', 32, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('sign_out','remove_this_item','remove_this_item'));
?>
<?php  ob_start();  ?>
<?php $__parent_tpl_vars = $__tpl_vars;$__tpl_vars = array_merge($__tpl_vars, array('but_text' => fn_get_lang_var('sign_out', $this->getLanguage()), 'but_onclick' => $__tpl_vars['but_onclick'], 'but_href' => $__tpl_vars['but_href'], 'but_role' => $__tpl_vars['but_role'], )); ?>
