<?php /* Smarty version 2.6.18, created on 2011-12-01 22:23:23
         compiled from views/site_layout/design_mode.tpl */ 
 $__tpl_vars = & $this->_tpl_vars;
 ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'defined', 'views/site_layout/design_mode.tpl', 7, false),array('modifier', 'fn_check_view_permissions', 'views/site_layout/design_mode.tpl', 42, false),array('modifier', 'default', 'views/site_layout/design_mode.tpl', 45, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('disable_translation_mode','view_storefront_translation_mode','enable_translation_mode','remove_this_item','remove_this_item','disable_customization_mode','view_storefront_customization_mode','enable_customization_mode','remove_this_item','remove_this_item','design_mode'));
?>
...
?dispatch=profiles.act_as_user&amp;user_id=<?php echo $__tpl_vars['auth']['user_id']; ?>
&amp;area=C" target="_blank"><?php echo fn_get_lang_var('view_storefront_translation_mode', $this->getLanguage()); ?>
</a>
	<?php else: ?>
	...
	<?php endif; ?>
	<p><?php $__parent_tpl_vars = $__tpl_vars;$__tpl_vars = array_merge($__tpl_vars, array('but_name' => $__tpl_vars['dispatch_val'], 'but_role' => 'button_main', 'but_text' => $__tpl_vars['mode_val'], )); ?>
...
" method="post" name="customization_mode_form">
	...
	<?php if (defined('CUSTOMIZATION_MODE')): ?>
		...
		<a href="<?php echo $__tpl_vars['index_script']; ?>
?dispatch=profiles.act_as_user&amp;user_id=<?php echo $__tpl_vars['auth']['user_id']; ?>
&amp;area=C" target="_blank"><?php echo fn_get_lang_var('view_storefront_customization_mode', $this->getLanguage()); ?>
</a>
	<?php else: ?>
...
<?php $_smarty_tpl_vars = $__tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "common_templates/mainbox.tpl", 'smarty_include_vars' => array('title' => fn_get_lang_var('design_mode', $this->getLanguage()),'content' => $this->_smarty_vars['capture']['mainbox'])));
