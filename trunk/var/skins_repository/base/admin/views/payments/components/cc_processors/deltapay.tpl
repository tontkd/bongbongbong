{* $Id: deltapay.tpl 6560 2008-12-15 11:41:36Z zeke $ *}

{assign var="payment_url" value="`$config.http_location`/`$config.customer_index`"}
{assign var="result_url" value="`$config.http_location`/`$config.customer_index`?dispatch=payment_notification.process&payment=deltapay"}
