	...
	EditArea.prototype.update_size= function(){
		...
		if(editAreas[editArea.id] && editAreas[editArea.id]["displayed"]==true){
			if(editArea.fullscreen['isFull']){	
				...
				parent.document.getElementById("template_editor_content").style.width= parent.document.getElementsByTagName("html")[0].clientWidth + "px";
				parent.document.getElementById("template_editor_content").style.height= parent.document.getElementsByTagName("html")[0].clientHeight + "px";
			...
			var height= document.body.offsetHeight - editArea.get_all_toolbar_height() - 2;
