{* $Id: customer_info.tpl 6892 2009-02-09 14:50:51Z angel $ *}
...
<p class="float-right"><a href="{$index_script}?dispatch=checkout.customer_info">{$lang.more_sign_in_options}</a></p>
{/if}
...
{capture name="group"}
	...
	{include file="views/profiles/components/profile_fields.tpl" user_data=$udata section="S" title=$lang.shipping_address place_to_box=false body_id="sa" shipping_flag=$profile_fields.B|sizeof|default:false ship_to_another=$sh_to_a}
{/capture}
