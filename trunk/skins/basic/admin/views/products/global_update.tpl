{* $Id: global_update.tpl 6908 2009-02-13 14:24:43Z angel $ *}

{capture name="mainbox"}

<form action="{$index_script}" method="post" name="global_update_form" class="cm-form-highlight"/>
...
<div class="form-field">
	<label for="gu_thumbanils">{$lang.regenerate_thumbnails}:</label>
	<input type="checkbox" id="gu_thumbanils" name="update_data[regenerate_thumbnails]" value="Y" class="checkbox" />&nbsp;({$settings.Thumbnails.product_thumbnail_width}x{$settings.Thumbnails.product_thumbnail_height} px)
</div>
