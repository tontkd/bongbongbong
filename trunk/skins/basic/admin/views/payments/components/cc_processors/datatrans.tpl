{* $Id: datatrans.tpl 6966 2009-03-04 06:42:39Z angel $ *}

{assign var="post_url" value="`$config.http_location`/`$config.customer_index`?dispatch=payment_notification.notify&payment=datatrans"}
