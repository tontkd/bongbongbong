{* $Id: system.tpl 6001 2008-09-26 06:16:17Z angel $ *}
...
<div id="content_{$report_data.report}">
	...
	<tr {cycle values=", class=\"table-row\""}>
		...
		<td align="right">
			...
			{/if}
			<a href="{$index_script}?dispatch=statistics.visitors&amp;section=system&amp;report={$report_data.report}&amp;object_code={$object_code}">{$row.count}</a>
