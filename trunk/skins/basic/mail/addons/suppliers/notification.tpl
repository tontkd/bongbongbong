{* $Id: notification.tpl 4250 2007-10-22 08:24:34Z seva $ *}
...
<span style="margin-left:20px;">&nbsp;</span>{if $settings.Company.company_address}{$settings.Company.company_address}, {/if}
				  ...
				  {if $settings.Company.company_state && $settings.Company.company_country}{$settings.Company.company_state|fn_get_state_name:$settings.Company.company_country}, {/if}
				  {$settings.Company.company_country|fn_get_country_name}<br />
