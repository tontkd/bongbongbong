{* $Id: details.post.tpl 6967 2009-03-04 09:26:06Z angel $ *}
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="table">
	...
	<tr {cycle values=",class=\"table-row\""}>
		...
		<td>
			<a href="{$index_script}?dispatch=products.view&amp;product_id={$product.product_id}" class="manage-root-item">{$product.product|unescape}</a>
