...
//
// $Id: config.php 7799 2009-08-10 12:51:24Z alexey $
//
...
Registry::set('crawlers', array(
	'abou', 'alta', 'ask', 'asps', 'atomz', 'b2w', 'back', 'blowfish', 'bookmark', 'bot', 'brouser', 
	'eye', 'catch', 'cgi', 'cosmos', 'crawl', 'data', 'download', 'easy', 'email', 'fetch', 'fusion', 
	'generic', 'get', 'go', 'grub', 'gulli', 'hitwise', 'httplib', 'java', 'link', 'load', 'lycos', 
	'net', 'netmind', 'ninj', 'offline', 'page', 'php', 'picker', 'power', 'pro', 'proxy', 'python', 
	'scan', 'scout', 'search', 'seek', 'site', 'slurp', 'spanner', 'spide', 'spider', 'spyder', 'super', 
	'tele', 'tools', 'tracker', 'url', 'web', 'wget', 'www-perl', 'zao', 'zeus'
));
