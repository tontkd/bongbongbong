<?php
	...
	{
		echo '<p style="font-family: Tahoma, Verdana; font-size:14px"><font color="red"><b>Error!</b></font><br />
			  Can\'t load settings. WebMail probably not configured.
			  </p>';
		exit();		
	}
	...
	{
		echo '<p style="font-family: Tahoma, Verdana; font-size:14px"><font color="red"><b>Error!</b></font><br />
			  Can\'t create tables. Data Base type not MySql or MsSql.
			  </p>';
		exit();
	}
	...
	if (!$dbStorage->Connect())
	{
		...
		echo '<p style="font-family: Tahoma, Verdana; font-size:14px"><font color="red" style="font-family: Tahoma, Verdana;"><b>Warning!</b></font><br />
	...
	$nextButton = '<input type="button" value="Next Step" style="font-weight: bold" />z';
	switch ($step)
	{	
		default:
		case 1:
			...
			elseif ($is_good && strlen($is_good) > 0)
			{
				...
				needed for handling with MailBee WebMail Pro<br /><br />
		...
		case 2:
			...
			if ($is_good === true)
			{
				if ($dbStorage->CreateAllIndex($settings->DbPrefix))
				{
