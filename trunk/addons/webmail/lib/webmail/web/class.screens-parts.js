...
function CToolBar(parent, skinName)
{
	...
	this._descriptions[TOOLBAR_BACK_TO_LIST] = {
		title: Lang.BackToList,
		imgFile: 'back_to_list.gif',
		imgClass: 'wm_menu_back_to_list_img',
		langField: 'BackToList'
	};
...
function CFolderParams(sentDraftsType, type, syncType, count, newCount, name) {
...
CFolderLine.prototype = {
	...
	SaveName: function () {
		...
		if (Trim(value).length != 0 && this._fold.Name != value ) {
			...
			if (!val.IsCorrectFileName(value)) {
