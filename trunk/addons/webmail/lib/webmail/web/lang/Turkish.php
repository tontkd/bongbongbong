...
// interface strings
	...
	define('JS_LANG_LanguageEnglish', 'İngilizce');
	define('JS_LANG_LanguageCatala', 'Katalonya');
	define('JS_LANG_LanguageNederlands', 'Flemenkçe');
	define('JS_LANG_LanguageFrench', 'Fransızca');
	define('JS_LANG_LanguageGerman', 'Almanca');
	define('JS_LANG_LanguageItaliano', 'İtalyanca');
	define('JS_LANG_LanguagePortuguese', 'Portekizce (BR)');
	define('JS_LANG_LanguageEspanyol', 'İspanyolca');
	define('JS_LANG_LanguageSwedish', 'İsveççe');
	define('JS_LANG_LanguageTurkish', 'Türkçe');

	define('JS_LANG_DateDefault', 'Öntanımlı');
	define('JS_LANG_DateDDMMYY', 'DD/MM/YY');
	define('JS_LANG_DateMMDDYY', 'MM/DD/YY');
	define('JS_LANG_DateDDMonth', 'DD Ay (01 Oca)');
...
//Contact(s) was added to group "friends".
	...
	define('LanguageDanish', 'Danimarka dili');
	define('LanguagePolish', 'Lehçe');
