	...
	EditArea.prototype.get_selection_infos= function(){
		if(this.nav['isIE'])
			this.getIESelection();
		start = this.textarea.offsetWidth > 0 ? this.textarea.selectionStart : 0;
		end = this.textarea.offsetWidth > 0 ? this.textarea.selectionEnd : 0;
		...
		selections["indexOfCursor"] = this.textarea.offsetWidth > 0 ? this.textarea.selectionStart : 0;
