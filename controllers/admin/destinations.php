...
//
// $Id: destinations.php 7502 2009-05-19 14:54:59Z zeke $
//
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	return array(CONTROLLER_STATUS_OK, "$index_script?dispatch=destinations$suffix");
}
...
if ($mode == 'update') {
	...
	fn_add_breadcrumb(fn_get_lang_var('locations'), "$index_script?dispatch=destinations.manage");
...
// Destinations list
	...
	return array(CONTROLLER_STATUS_REDIRECT, "$index_script?dispatch=destinations.manage");
}
