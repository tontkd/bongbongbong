{* $Id: view.tpl 7328 2009-04-21 12:49:32Z lexa $ *}
...
<div class="clear">
	<form action="{$index_script}" method="post" name="product_details_form_{$product.product_id}">
	...
	<div class="product-description">
		...
		{hook name="products:prices_block"}
			{if $product.discount} 	{********************** Old Price *****************}
				<span class="list-price" id="line_old_price_{$obj_id}">{$lang.old_price}: {include file="common_templates/price.tpl" value=$product.base_price span_id="old_price_`$d`" class="list-price"}</span>
