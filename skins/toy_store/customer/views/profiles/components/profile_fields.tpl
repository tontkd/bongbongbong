...
<div class="form-field">
	...
	{elseif $field.field_type == "R"}  {* Radiogroup *}
		...
		<input class="radio valign" type="radio" id="{$id_prefix}elm_{$field.field_id}_{$k}" name="{$data_name}[{$data_id}]" value="{$k}" {if (!$value && $smarty.foreach.rfe.first) || $value == $k}checked="checked"{/if} {$disabled_param} /><span class="radio">{$v}</span>
		{/foreach}
