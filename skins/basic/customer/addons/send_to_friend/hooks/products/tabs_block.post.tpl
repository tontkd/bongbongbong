{* $Id: tabs_block.post.tpl 7061 2009-03-18 08:54:48Z zeke $ *}

<div id="content_send_to_friend">
<form name="send_to_friend_form" action="{$index_script}" method="post">
<input type="hidden" name="redirect_url" value="{$config.current_url}&amp;selected_section=send_to_friend" />
