{* $Id: graphic_banner_update.tpl 6713 2009-01-06 15:38:06Z zeke $ *}

{** include fileuploader **}
{include file="common_templates/file_browser.tpl"}
{** /include fileuploader **}

<form action="{$index_script}" method="post" name="banner_form" class="cm-form-highlight" enctype="multipart/form-data">
...
<div class="form-field">
	<label class="cm-required">{$lang.image}:</label>
...
{if $link_to == "G"}
	<div class="form-field">
		<label for="group_id" class="cm-required">{$lang.product_group}:</label>
...
{elseif $link_to == "C"}
	...
	{include file="pickers/categories_picker.tpl" input_name="banner[data]" item_ids=$c_ids multiple=true}
...
<div class="buttons-container buttons-bg">
	{if $mode == "add"}
		{include file="buttons/create_cancel.tpl" but_name="dispatch[banners_manager.update]"}
	{else}
