...
//		}
	...
	this.GetMessageExternalHeight = function()
	{
		...
		var offsetHeight = this._hResizerCont.offsetHeight;
		if (offsetHeight) {
			this._hResizerHeight = offsetHeight;
		};
	...
	this.CleanMessageBody = function (showInfo)
	{
		this._msgObj = null;
	...
	this.FillByMessage = function()
	{
		...
		var htmlMode = this._msgViewer.Fill(thisMessage);
		if (!htmlMode) {
		    this._picturesControl.Hide();
		};
		this.ResizeBody('all');
	...
	this.BuildMessageContainer = function(td)
	{
		...
		div2 = CreateChildWithAttrs(this._messageHeadersContainer, 'div', [['style', 'width:0px;height:0px;overflow:hidden;clear:both']]);
