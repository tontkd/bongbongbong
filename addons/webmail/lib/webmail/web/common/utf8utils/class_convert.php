...
class CConvertUtf8 
{
	...
	function substr($str, $start, $length = null)
	{
		...
		return ($length != null)
			? implode('',array_slice($ar[0],$start,$length))
			: implode('',array_slice($ar[0],$start));
	} 
	
	function strrpos($haystack, $needle) 
	{
		$pos = strrpos($haystack, $needle);
		return ($pos === false) ? false : CConvertUtf8::strlen(substr($haystack, 0, $pos));
	}
	...
	function StrToLower($str) 
	{
		...
		return strtr(strtolower($str), $mapping);
	}
	...
	function StrToUpper($str) 
	{
		...
		return strtr(strtoupper($str), $mapping);
	}
}